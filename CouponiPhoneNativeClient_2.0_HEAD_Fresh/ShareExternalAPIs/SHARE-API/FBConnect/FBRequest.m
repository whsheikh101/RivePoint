...
{
    if ([_delegate respondsToSelector:@selector(imageUploadProgress:bytesExpected:)]) {
        [_delegate imageUploadProgress:totalBytesWritten bytesExpected:totalBytesExpectedToWrite];
    }
}
